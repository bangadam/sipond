...
<link href="{{URL::to('admin/assets/css/skins/header/base/light.css')}}" rel="stylesheet" type="text/css" />
<link href="{{URL::to('admin/assets/css/skins/header/menu/light.css')}}" rel="stylesheet" type="text/css" />
<link href="{{URL::to('admin/assets/css/skins/brand/light.css')}}" rel="stylesheet" type="text/css" />
